...
//////////////////////////////////////////////////////////////////////////////////	 
//-----------------LCD端口定义---------------- 
#define	LCD_LED PDout(13) //LCD背光    		 PD11 	    
//LCD地址结构体
// typedef struct
// {
// 	u16 LCD_REG;
...
#define LCD_BASE        ((u32)(0x60000000 ))//A10
//	*(volatile u16 *)(Bank1_LCD_CMD_ADDR) = LCD_Reg;
//	*(volatile u16 *)(Bank1_LCD_DATA_ADDR)
// #define LCD->LCD_RAM  (*(volatile u16 *)(Bank1_LCD_DATA_ADDR))            
// #define LCD->LCD_REG  (*(volatile u16 *)(Bank1_LCD_CMD_ADDR))
//////////////////////////////////////////////////////////////////////////////////
#define Bank1_LCD_DATA_ADDR    ((uint32_t)0x60020000)    //显示区数据地址	  
#define Bank1_LCD_CMD_ADDR    ((uint32_t)0x60000000)	   //显示区指令地址	 寄存器	 
//扫描方向定义
