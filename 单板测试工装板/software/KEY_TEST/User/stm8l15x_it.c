...
INTERRUPT_HANDLER(EXTID_H_IRQHandler,7)
{
    ...
    */
    ...
    if(READ_KEY1() == RESET)
    {
        MyFlagSturct.Key1Flag = 1;

    }
   
    if(READ_KEY2() == RESET)
    {
        MyFlagSturct.Key2Flag = 1;

    }
   
    if(READ_KEY3() == RESET)
    {
        MyFlagSturct.Key3Flag = 1;

    }
   
    if(READ_KEY4() == RESET)
    {
        MyFlagSturct.Key4Flag = 1;
...
INTERRUPT_HANDLER(EXTI2_IRQHandler,10)
{
    ...
    */
    ...
    if(READ_KEY() == RESET)
    {
        ...
        MyFlagSturct.FunFlag++;
        MyFlagSturct.KeyState = TRUE;
        while(READ_KEY() == RESET);
